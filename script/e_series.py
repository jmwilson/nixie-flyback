...
e6_values = [1.0, 1.5, 2.2, 3.3, 4.7, 6.8, 10.0]
...
def nearest_series_value(value, series):
    exp = math.floor(math.log10(value))
    scaled_series = [s * 10**exp for s in series]
    return min(scaled_series, key=lambda s: abs(s - value))

e6 = lambda r: nearest_series_value(r, e6_values)
e12 = lambda r: nearest_series_value(r, e12_values)
e24 = lambda r: nearest_series_value(r, e24_values)
e48 = lambda r: nearest_series_value(r, e48_values)
e96 = lambda r: nearest_series_value(r, e96_values)
e192 = lambda r: nearest_series_value(r, e192_values)
